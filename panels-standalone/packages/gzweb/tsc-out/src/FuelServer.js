export const FUEL_HOST = "fuel.gazebosim.org";
export const FUEL_VERSION = "1.0";
export const IGN_FUEL_HOST = "fuel.ignitionrobotics.org";
/**
 ...
 */
export function createFuelUri(uri) {
    // Check if it's already a Fuel URI.
    if (uri.startsWith(`https://${FUEL_HOST}`) ||
