// Ported from: lichtblick/packages/suite-base/src/panels/Teleop/constants.ts
// Date: 2025-11-06
// Modifications: None - pure data file copied directly
...
export const svgPathsEnabled = {
  ...
  right: "M219.572,50.364c37.794,44.609 37.791,110.387 0.001,154.981l-42.724,-42.723c14.771,-20.74 14.771,-48.795 0,-69.535l42.723,-42.723Z",
};
