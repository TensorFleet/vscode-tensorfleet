...
TensorFleet Drone Suite is available under a dual licensing model:
...
### GPL License Terms Summary

When using TensorFleet Drone Suite under the GPL license:

- ✅ You may use, modify, and distribute the software
- ✅ You may use it for commercial purposes
- ✅ You must make your modifications available under GPL-3.0
- ✅ You must include the original copyright notice and license
- ✅ If you distribute the software, you must provide the source code
- ✅ Any derivative works must also be licensed under GPL-3.0

## Option 2: Commercial License

If you need to use TensorFleet Drone Suite in a proprietary application or cannot comply with the GPL license terms, a commercial license is available.

### Commercial License Benefits

- ✅ Use in proprietary/commercial products without GPL obligations
- ✅ No requirement to disclose your source code
- ✅ No requirement to license your derivative works under GPL
...
Copyright (c) 2024 TensorFleet. All rights reserved.
